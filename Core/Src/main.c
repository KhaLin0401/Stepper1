...
/**
 ...
 static void MX_TIM3_Init(void)
 {
   ...
   htim3.Instance = TIM3;
   htim3.Init.Prescaler = 71; // F_timer = 72MHz / (71+1) = 1MHz
   htim3.Init.CounterMode = TIM_COUNTERMODE_UP;
   htim3.Init.Period = 19999; // PWM frequency = 1MHz / 20000 = 50Hz (bạn có thể chỉnh theo nhu cầu)
   ...
   sConfigOC.OCMode = TIM_OCMODE_PWM1;
   sConfigOC.Pulse = 0; // Duty cycle ban đầu = 0%
   sConfigOC.OCPolarity = TIM_OCPOLARITY_HIGH;
   sConfigOC.OCFastMode = TIM_OCFAST_DISABLE;
